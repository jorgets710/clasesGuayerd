...
// como ordenar arrays solo string
...
const fisherYates = [23, 43, 65, 76, 98, 45, 09, 23, 4, 5, 6, 32, 45, 665,]
...
// valor minimo dentro de un arrat
fisherYates.sort(function (a, b) {
    return a - b
})
...
// ordenar propiedades en un array
/*const autosIncomparables = [
    { type: " ferrari", anio: "2010" },
    { type: "lamborgine", anio: "2003" },
    { type: "porsche", anio: "1968" }
]
console.log(autosIncomparables)
autosIncomparables.sort(function(a, b) {return b.anio - a.anio});
console.log(autosIncomparables);


autosIncomparables.sort(function (a, b) {
    return a.anio - b.anio 
})
console.log(autosIncomparables); // ARREGLAR*/
...
// el argumento map que sirve para 
